...
<head>
    ...
    <title>Food Order Website - user</title>
</head>
...
<body>
            ...
            <div class="row">
                <div class="col menu">
                    <ul class="nav justify-content-center text-center">
                        ...
                        <li>
                            <a class="menu-admin-text" href="./manage_food">Food</a>
                        </li>
                        <li>
    ...
    <section class="content bg-light">
        <div class="container">
            <h5 class="text-left">Manage Users</h5>
            <form action="">
                <input type="submit" name="submit" value="Add New User" class="buton">
            </form>
            <div class="row">
